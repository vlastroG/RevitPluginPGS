...
{
    public class MulticategoryInLinkSelectionFilter : ISelectionFilter
    {
        private Document _doc;

        private IEnumerable<BuiltInCategory> _categories;

        public MulticategoryInLinkSelectionFilter(Document doc, IEnumerable<BuiltInCategory> categories)
        {
            _doc = doc;
